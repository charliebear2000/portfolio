      ...
      <>
         ...
         <div className="project-container">
            ...
            <div className="project-item">
                  <a className="project" id="project-1" href="https://bistro-box.herokuapp.com/">
                  </a>
                  <a className="project-link" href="https://github.com/charliebear2000/BistroBox">
                     BistroBox &emsp;<img src="https://img.icons8.com/metro/26/000000/github.png" alt=""/>
                  </a>
               </div>

               <div className="project-item">
                  <a className="project" id="project-2" href="https://ckoehler16.github.io/Cocktail-Generator/">
                  </a>
               ...
               <div className="project-item">
                  <a className="project" id="project-3" href="https://shrouded-gorge-64455.herokuapp.com/">
                  </a>
               ...
               <div className="project-item">
                  <a className="project" id="project-4" href="https://salty-cove-18833.herokuapp.com/">
                  </a>
               ...
               <div className="project-item">
                  <a className="project" id="project-5" href="https://charliebear2000.github.io/java-quiz/">
                  </a>
               ...
               <div className="project-item">
                  <a className="project" id="project-6" href="https://limitless-everglades-40036.herokuapp.com/">
                  </a>
